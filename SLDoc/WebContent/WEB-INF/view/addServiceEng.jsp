		...
		<div class="content-wrapper">
			...
			<div class="content-header row">
				<div class="content-header-left col-md-6 col-xs-12">
					<h2 class="content-header-title mb-0"><i class="icon-user-tie"></i> Service Eng Master</h2>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<div class="col-md-12">
									<h4 class="card-title" id="striped-label-layout-icons">Update Service Eng Detail of <%=fullname%></h4>
								</div>
											...
											<input type="hidden" id="cId" name="cId" value="<%=cid%>">
													...
													<label>Products</label>
																...
																<select class="selectize-multiple"  placeholder="----Select process----" name="updateProdIdd" id="updateProdIdd" multiple="multiple" required>
																	...
																	String siddd = String.valueOf(pIdddd);	
																		boolean flag = false;
																	...
																	%>
																		...
																		<%if(flag == true){%>
																			<option value="<%=siddd%>" selected="selected"><%=p.getProduct_name()%></option>
																		<%}else{ %>
																			<option value="<%=siddd%>"><%=p.getProduct_name()%></option>
																		<%} %>
