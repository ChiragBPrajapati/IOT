      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12">
            <h2 class="content-header-title mb-0">Folder List</h2>
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-xs-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Folder List
                  </li>
                </ol>
              </div>
            </div>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
            	<h4 class="card-title">Folder List</h4>
				        ...
				        for (int i = 0; i < listOfFiles.length; i++) {
				          if (directory.isDirectory()) {
				           // System.out.println("File " + listOfFiles[i].getName());
							...
							count++;
							File directory1 =new File("D:\\datastorae\\SLDoc\\application\\"+sector_name+"\\"+product_name+"\\"+listOfFiles[i].getName()+"");
						       long size = FileUtils.sizeOfDirectory(directory1);
				          ...
				          <td style="font-size: 30px;"><%=count %></td>
				            <td style="font-size: 23px;"><a href="redirect?p=c2VydmljZURvY3VtZW50cw==&product_name=<%=product_name%>&attachment=<%=listOfFiles[i].getName()%>&sector_name=<%=sector_name%>"><%=listOfFiles[i].getName()%></a></td>
				              <td><%=strDate%></td>
				               <td><%=fileSizeInMB%> MB</td>
				             <td class="i-xxxlarge"><a href="redirect?p=c2VydmljZURvY3VtZW50cw==&product_name=<%=product_name%>&attachment=<%=listOfFiles[i].getName()%>&sector_name=<%=sector_name%>"><i class="icon-eye info"  style="font-size: 2.00em;"></i></a></td>
