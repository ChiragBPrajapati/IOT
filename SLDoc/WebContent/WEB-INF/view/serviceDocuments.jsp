            ...
            <div class="card-body collapse in">
                <div class="card-block">
	                ...
	                <table id="project-task-list" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
				        ...
				        File directory=new File("D:\\datastorae\\SLDoc\\application\\"+sector_name+"\\"+product_name+"\\"+attachment+"");
					    int fileCount=directory.list().length;
				        File[] files = new File("directory").listFiles();
		
				        
				        
				        File folder = new File("D:\\datastorae\\SLDoc\\application\\"+sector_name+"\\"+product_name+"\\"+attachment+"");
				        ...
				        for (int i = 0; i < listOfFiles.length; i++) {
				          ...
				          <td style="font-size: 30px;"><%=count %></td>
				            <td><%=listOfFiles[i].getName()%></td>
				             ...
				             <td class="i-xxxlarge"><a href="appYearDownload?product_name=<%=product_name%>&attachment=<%=listOfFiles[i].getName()%>&year=<%=attachment%>&sector_name=<%=sector_name%>"><i class="icon-folder-download info"></i></a></td>
